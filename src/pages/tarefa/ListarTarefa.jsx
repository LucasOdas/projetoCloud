...
const initialRows = [
  createData(1, 'Tarefa 1', 'Descrição da Tarefa 1', '2022-01-01', '2022-01-02', 'Concluída', 'TI'),
  createData(2, 'Tarefa 2', 'Descrição da Tarefa 2', '2022-01-01', '2022-01-02', 'Em Andamento', 'Admistrativo'),
  createData(3, 'Tarefa 3', 'Descrição da Tarefa 3', '2022-01-01', '2022-01-02', 'Aguardando', 'Financeiro'),
];
...
const ListarTarefa = () => {
  ...
  const handleEditar = (id) => {
    ...
    const tarefaParaEditar = tarefas.find((obj) => obj.idTarefa === id) || null;
            ...
            <Table sx={{ minWidth: 650 }} size="small" aria-label="a dense table">
              <TableHead>
                <TableRow>
                  ...
                  <TableCell align="right">Área do Projeto</TableCell>
