      ...
      <Card sx={style}>
        ...
        <CardContent sx={{
          ...
          <Grid container spacing={2} mt={1}>
            ...
            <Grid item xs={3}>  
              <FormControl fullWidth>
                <InputLabel htmlFor="tarefa_recurso">Área do Projeto</InputLabel>
                <Select
                  id="tarefa_recurso"
                  value={recursoTarefa}
                  label="Recurso"
                ...
                >
                  <MenuItem value={'Recurso 1'}>TI</MenuItem>
                  <MenuItem value={'Recurso 2'}>Administrativo</MenuItem>
            ...
            <Grid container spacing={2} pl={2} mt={2}>
              <Grid item xs={1}>
                <Button size="small" variant="contained" onClick={handleEditar} color='red'>Salvar</Button>
              </Grid>  
              <Grid item xs={1}>  
